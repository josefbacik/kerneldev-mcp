            ...
            for dev in devices:
                ...
                try:
                    with open(dev_path, 'r+b') as f:
                        ...
                        assert read_back == test_data, f"Data mismatch: expected {test_data[:20]}..., got {read_back[:20]}..."
                ...
                try:
                    ...
                    if result.returncode == 0:
                        ...
                        logger.info(f"mkfs.ext4 returned {result.returncode} (may need different permissions)")
