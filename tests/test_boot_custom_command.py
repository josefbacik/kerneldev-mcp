...
class TestBootCustomCommandSignature:
    ...
    def test_boot_with_custom_command_method_exists(self):
        ...
        assert callable(method), \
            "boot_with_custom_command should be callable"
    ...
    def test_boot_with_custom_command_has_required_parameters(self):
        ...
        for param in required_params:
            assert param in params, \
                f"boot_with_custom_command must have '{param}' parameter"
    ...
    def test_boot_with_custom_command_has_documentation(self):
        ...
        assert docstring is not None, \
            "boot_with_custom_command should have documentation"
        ...
        for keyword in required_docs:
            assert keyword in docstring_lower, \
                f"Documentation should mention '{keyword}'"
...
class TestBootCustomCommandMCPTool:
    ...
    def test_tool_schema_has_required_fields(self):
        ...
        for field in required_fields:
            assert field in tool_def, \
                f"Tool schema should include {field} property"
    ...
    def test_tool_description_mentions_key_features(self):
        ...
        for feature in key_features:
            assert feature in tool_def_lower, \
                f"Tool description should mention '{feature}'"
    ...
    def test_tool_has_required_parameters_marked(self):
        ...
        assert '"required"' in tool_def, \
            "Tool schema should specify required parameters"
...
class TestBootCustomCommandHandler:
    ...
    def test_handler_processes_optional_command_and_script(self):
        ...
        assert 'arguments.get("command")' in handler_code or \
               'arguments.get(\'command\')' in handler_code, \
            "Handler should retrieve command parameter"

        assert 'script_file' in handler_code, \
            "Handler should handle script_file parameter"
...
class TestBootCustomCommandEnvironmentSetup:
    ...
    def test_method_sets_up_device_environment(self):
        ...
        assert 'loop' in source.lower(), \
            "Method should create loop devices for fstests environment"
    ...
    def test_method_supports_all_three_modes(self):
        ...
        assert 'script_file' in source, \
            "Method should handle script_file parameter"
    ...
    def test_method_creates_timestamped_results_directory(self):
        ...
        assert 'results' in source.lower(), \
            "Method should create results directory"
